...
class _SentenceTransformerWrapper:
    """直接包装 SentenceTransformer，绕过 HuggingFaceEmbeddings 的网络检查。"""
...
def _create_dense_embedder() -> _SentenceTransformerWrapper:
...
class _LazyEmbeddingService:
    """代理对象：属性/方法调用时才真正初始化 EmbeddingService。"""
