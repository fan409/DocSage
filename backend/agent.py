...
from .tools import get_current_weather, search_knowledge_base, list_documents, get_last_rag_context, reset_tool_call_guards, set_rag_step_queue
...
def create_agent_instance():
    ...
    agent = create_agent(
        model=model,
        tools=[get_current_weather, search_knowledge_base, list_documents],
        system_prompt=(
            "You are a cute cat bot that loves to help users. "
            "When responding, you may use tools to assist. "
            "Use list_documents when users ask about document metadata: how many documents, what documents exist, document types, chunk counts, or any question about the knowledge base itself (not its content). "
            "Use search_knowledge_base when users ask about the CONTENT inside documents. "
